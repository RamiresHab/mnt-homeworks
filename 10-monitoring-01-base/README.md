...
Нужно настроить алармы на загрузку CPU, RAM и дисковой системы и реагировать на них, когда загрузка превышает определённые пределы.
Таким образом мы не будем доводить систему до критических значений нагрузки и она всегда будет доступна.
Также нужно прочитать SLI с клиентами и выводить метрики по соотношению неуспешных http ответов с успешным.
По всем неуспешным http ответам надо проводить расследования и устранять причины до того, как их количество превысит SLI
...
Ответ:
Помимо 5хх и 4хх у нас могут быть другие коды ответов, правильнее было бы сделать формулу 
1-summ_4xx_requests/summ_all_requests-summ_5xx_requests/summ_all_requests.
Таким образом мы получим процент всех ответов, кроме 4хх и 5хх
